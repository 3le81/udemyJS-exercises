...
let score_Dolphins = (97 + 112 + 101) / 3;
let score_Koalas = (109 + 95 + 123) / 3;
...
// } else {
//     console.log("There's a draw and both won the trophy!!");
// }

if (score_Dolphins >= 100 && score_Dolphins > score_Koalas) {
    console.log("Dolphins won the trophy!");
} else if (score_Koalas >= 100 && score_Koalas > score_Dolphins) {
    console.log("Koalas won the trophy!");
